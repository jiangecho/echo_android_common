...
public class EnterEmojiLayout extends EnterLayout {
    ...
    public EnterEmojiLayout(AppCompatActivity activity, View.OnClickListener sendTextOnClick, Type type) {
        this(activity, sendTextOnClick, type, EmojiType.Default);
    }

    public EnterEmojiLayout(final AppCompatActivity activity, View.OnClickListener sendTextOnClick, Type type, EmojiType emojiType) {
            ...
            public void onClick(View v) {
                ...
                if (checkBoxEmoji.isChecked()) {
                    ...
                    if (rootParentHigh - rootViewHigh > bottomHigh) {
                        ...
                        Global.popSoftkeyboard(mActivity, content, false);
                        emojiKeyboardLayout.postDelayed(new Runnable() {
                            @Override
                            public void run() {
...
//        rootView = mActivity.findViewById(R.id.root_layout);
//        if (rootView == null) {
//            rootView = mActivity.findViewById(android.R.id.content);
//        }
    ...
    public EnterEmojiLayout(AppCompatActivity activity, View.OnClickListener sendTextOnClick) {
